...
#calculating 10-fold cross validation with KNN for k = 30 , and distance types = 'Euc' , 'Mnhtn' , 'Cosin'
for dist_type in ['Euc' , 'Mnhtn' , 'Cosin']:
    y_pred = K_fold(X , Y , 30 , dist_type)
